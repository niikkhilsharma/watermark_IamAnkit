		...
		<section className='dark:bg-gray-800 dark:text-gray-100'>
			<div className='container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl'>
				<div>
					...
					<p className='max-w-3xl mx-auto mt-4 text-xl text-center dark:text-gray-400'>You are not the right place.</p>
				</div>
				<div>
					<div className='grid lg:gap-8 lg:grid-cols-2 lg:items-center'>
						<div className='lg:col-start-2'>
							<h3 className='text-2xl font-bold tracki sm:text-3xl dark:text-gray-50'>Check out our main features</h3>
							...
							<div className='mt-12 space-y-12'>
								...
								<div className='flex'>
									...
									<div className='ml-4'>
										...
										<p className='mt-2 dark:text-gray-400'>
											Te per quidam maiorum ocurreret, etiam delicatissimi usu ad. Ne has quod periculis. Te sit primis iisque
											efficiantur.
										</p>
									</div>
								</div>
